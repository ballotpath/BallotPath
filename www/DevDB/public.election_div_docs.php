 ...
 */
    ...
    class public_election_div_docsPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_election_div_docsssearch', $this->dataset,
                ...
                array($this->RenderText('Election Div Id'), $this->RenderText('Name'), $this->RenderText('Link')),
                array(
    ...
    try
    {
        ...
        $Page->SetShortCaption('Public.Election Div Docs');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Public.Election Div Docs');
