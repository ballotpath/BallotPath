 ...
 */
    ...
    class public_officePage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('public_officessearch', $this->dataset,
                array('title', 'num_positions', 'responsibilities', 'term_length_months', 'filing_fee', 'partisan', 'age_requirements', 'res_requirements', 'prof_requirements', 'salary', 'notes'),
                array($this->RenderText('Title'), $this->RenderText('Num Positions'), $this->RenderText('Responsibilities'), $this->RenderText('Term Length Months'), $this->RenderText('Filing Fee'), $this->RenderText('Partisan'), $this->RenderText('Age Requirements'), $this->RenderText('Res Requirements'), $this->RenderText('Prof Requirements'), $this->RenderText('Salary'), $this->RenderText('Notes')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('num_positions', $this->RenderText('Num Positions')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('term_length_months', $this->RenderText('Term Length Months')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('partisan', $this->RenderText('Partisan')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('res_requirements', $this->RenderText('Res Requirements')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('prof_requirements', $this->RenderText('Prof Requirements')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('num_positions', 'Num Positions', $this->dataset);
            $column->SetOrderable(true);
            ...
            $editColumn = new CustomEditColumn('Num Positions', 'num_positions', $editor, $this->dataset);
            ...
            $column->SetFullTextWindowHandlerName('responsibilities_handler');
            ...
            //
            $column = new TextViewColumn('term_length_months', 'Term Length Months', $this->dataset);
            $column->SetOrderable(true);
            ...
            $editColumn = new CustomEditColumn('Term Length Months', 'term_length_months', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('filing_fee_handler');
            ...
            //
            $column = new TextViewColumn('partisan', 'Partisan', $this->dataset);
            $column->SetOrderable(true);
            ...
            $editColumn = new CustomEditColumn('Partisan', 'partisan', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('res_requirements_handler');
            ...
            $editColumn = new CustomEditColumn('Res Requirements', 'res_requirements', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('prof_requirements_handler');
            ...
            $editColumn = new CustomEditColumn('Prof Requirements', 'prof_requirements', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
        ...
        protected function CreateGrid()
        {
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'responsibilities_handler', $column);
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'filing_fee_handler', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for res_requirements field
            //
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'res_requirements_handler', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for prof_requirements field
            //
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'prof_requirements_handler', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for notes field
            //
    ...
    try
    {
        ...
        $Page->SetShortCaption('Public.Office');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Public.Office');
