 ...
 */
    ...
    class officeHolderIDsPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('officeHolderIDsssearch', $this->dataset,
                array('id', 'concat'),
                array($this->RenderText('Id'), $this->RenderText('Concat')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('officeHolderIDsasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id', $this->RenderText('Id')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('concat', $this->RenderText('Concat')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('concat', 'Concat', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for concat field
            //
            $editor = new TextEdit('concat_edit');
            $editColumn = new CustomEditColumn('Concat', 'concat', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
        ...
        {
            $result = new Grid($this, $this->dataset, 'officeHolderIDsGrid');
    ...
    try
    {
        $Page = new officeHolderIDsPage("officeHolderIDs.php", "officeHolderIDs", GetCurrentUserGrantForDataSource("officeHolderIDs"), 'UTF-8');
        $Page->SetShortCaption('OfficeHolderIDs');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('OfficeHolderIDs');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("officeHolderIDs"));
