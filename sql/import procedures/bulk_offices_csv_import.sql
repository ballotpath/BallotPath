...
$BODY$
  ...
  CREATE TEMPORARY TABLE bulk_staging (
    ...
    holder_addr1 character varying(25),
    holder_addr2 character varying(25),
    holder_city character varying(25),
    ...
    office_notes text,
    office_rank integer,
    office_doc_name character varying(35),
...
--TODO: verify position has a related office?
...
INSERT into office_staging (title
	...
	FROM bulk_staging bs LEFT OUTER JOIN district d on bs.district_name = d.name and bs.district_state = d.state
		LEFT OUTER JOIN election_div ed on bs.election_div_name = ed.name);
	--GROUP BY title, district_name, district_state, election_div_name);
