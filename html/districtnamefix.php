...
<head>
    ...
    <title>District Name Correction Form Upload</title>
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h4 class="panel-title">
					District Name Correction Form Upload
				</h4>
			</div>
			<div class="inpCenter panel-body">
<form name="uploadfiles" method="post" enctype="multipart/form-data" action="districtnameupload.php">   
    <p><label for="shp">Select CSV for upload: </label><input type="file" name="csv" accept=".csv"/>
