<?php require($DOCUMENT_ROOT . "/inc/header.html"); ?>
	...
	<title>Ballot Path - About Us</title>
</head>
...
<body>
    ...
    <div class="intro-header">
		...
		Ballot Path is a collaborative project that is meant to help citizens:<br><br>
		...
		Ballot Path is interested in making elections and candidacy information available to citizens in democracies around the world.
            </div>
        </div>
		</div>
    </div> 
