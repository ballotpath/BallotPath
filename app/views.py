...
from app import app, db, models, upload
import json
...
def parse_office_row(row):
    ...
    office_pos = {}
    office_pos['id'] = row[models.office_position.id]
    office_pos['district_id'] = row[models.office_position.district_id]
    office_pos['office_id'] = row[models.office_position.office_id]
    office_pos['office_holder_id'] = row[models.office_position.office_holder_id]
    office_pos['position_name'] = row[models.office_position.position_name]
    office_pos['term_start'] = row[models.office_position.term_start]
    office_pos['term_end'] = row[models.office_position.term_end]
    office_pos['filing_deadline'] = row[models.office_position.filing_deadline]
    office_pos['next_election'] = row[models.office_position.next_election]
    office_pos['notes'] = row[models.office_position.notes]
    # Next, extract office information
    office = {}
    office['id'] = row[models.office.id]
    office['title'] = row[models.office.title]
    office['num_positions'] = row[models.office.num_positions]
    office['responsibilities'] = row[models.office.responsibilities]
    office['term_length_months'] = row[models.office.term_length_months]
    office['filing_fee'] = row[models.office.filing_fee]
    office['partisan'] = row[models.office.partisan]
    office['age_requirements'] = row[models.office.age_requirements]
    office['res_requirements'] = row[models.office.res_requirements]
    office['prof_requirements'] = row[models.office.prof_requirements]
    office['salary'] = row[models.office.salary]
    office['notes'] = row[models.office.notes]
    # Put it in as a sub-object
    office_pos['office'] = office
    # Finally, extract office_holder information
    office_holder = {}
    office_holder['id'] = row[models.office_holder.id]
    office_holder['first_name'] = row[models.office_holder.first_name]
    office_holder['middle_name'] = row[models.office_holder.middle_name]
    office_holder['last_name'] = row[models.office_holder.last_name]
    office_holder['party_affiliation'] = row[models.office_holder.party_affiliation]
    office_holder['address1'] = row[models.office_holder.address1]
    office_holder['address2'] = row[models.office_holder.address2]
    office_holder['city'] = row[models.office_holder.city]
    office_holder['state'] = row[models.office_holder.state]
    office_holder['zip'] = row[models.office_holder.zip]
    office_holder['phone'] = row[models.office_holder.phone]
    office_holder['fax'] = row[models.office_holder.fax]
    office_holder['email_address'] = row[models.office_holder.email_address]
    office_holder['website'] = row[models.office_holder.website]
    office_holder['photo_link'] = row[models.office_holder.photo_link]
    office_holder['notes'] = row[models.office_holder.notes]
